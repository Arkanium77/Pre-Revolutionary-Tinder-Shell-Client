...
public class ClientProfile {
    ...
    public ClientProfile(UUID sessionId, String username, String password, String currentProfile) {
    ...
    public ClientProfile(UUID sessionId, String username, String password) {
        this.sessionId = sessionId;
        this.username = username;
        this.password = password;
    }
